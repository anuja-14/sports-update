  ...
  if (res.success) {
    ...
    BrowserPlus.require({services: [ ttsService ]},
      function(r) {
        ...
        alert("out");
          BrowserPlus.Notify.show({"title":"Hello World!","message":highlight+batsman_name+"    "+score_value,"icon":"http://l.yimg.com/a/i/us/bp/s/1.106/tool/notify-icon3.png"}, function(){});
          }
          else
          {
          BrowserPlus.Notify.show({"title":"Hello World!","message":highlight+"     "+score_value+msg,"icon":"http://l.yimg.com/a/i/us/bp/s/1.106/tool/notify-icon3.png"}, function(){});
          }
